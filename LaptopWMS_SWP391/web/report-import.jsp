    ...
    <body>
        <div class="container">
            ...
            <div class="filter-card">
                <form method="GET" action="report-import">
                    <div class="filter-row">
                        ...
                        <a href="report-import" class="btn btn-outline">Reset Filters</a>
                    </div>
                </form>
            </div>
            ...
            <div class="summary-grid">
                <div class="summary-card">
                    ...
                    <div class="label">Total Import Tickets</div>
                </div>
        ...
        <script>
            function exportCSV() {
                ...
                const url = `report-import?action=export&fromDate=${fromDate}&toDate=${toDate}&partnerId=${partnerId}&status=${status}`;
