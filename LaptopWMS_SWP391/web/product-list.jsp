    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="filter-container"
                 style="margin-bottom: 20px; padding: 15px; background: #fff; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.05);">
                <form action="product-list" method="get"
                    ...
                    <button type="submit" class="btn-filter"
                            style="padding: 6px 12px; background: #3498db; color: white; border: none; border-radius: 4px; cursor: pointer;">Search</button>
                    ...
                    <a href="product-list" class="btn-clear"
                                ...
                                <tr class="parent-row" onclick="toggleDetails('row-${p.productId}', this)">
                                    ...
                                    <td onclick="event.stopPropagation();">
                                        <a href="edit-product?id=${p.productId}"
                                           style="text-decoration: none; color: #3498db; margin-right: 10px;">Edit</a>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="edit-product-detail?id=${d.productDetailId}"
                                                                           style="color: #3498db; text-decoration: none; font-weight: 600;">Edit</a>
                                                                    </td>
                                                                </tr>
                                                            </c:forEach>
                                                        </c:when>
            ...
            <a href="<%= request.getContextPath()%>/landing"
               style="color: #bab0b0; font-style: italic; text-decoration: none;"><- Back to homepage</a>
        </div>
