                                    ...
                                    <tr class="parent-row" onclick="toggleDetails('row-${p.productId}', this)">
                                        ...
                                        <td onclick="event.stopPropagation();">
                                            ...
                                            <a href="javascript:void(0)"
                                               onclick="confirmStatusChange('toggleProduct?id=${p.productId}', 'this product', ${p.status})"
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${not empty p.detailsList}">
                                                                <c:forEach var="d" items="${p.detailsList}">
                                                                    <tr>
                                                                        <td><span
                                                                                class="spec-badge">${d.cpu}</span>
                                                                        </td>
                                                                        <td><span
                                                                                class="spec-badge">${d.gpu}</span>
                                                                        </td>
                                                                        <td><span
                                                                                class="spec-badge">${d.ram}</span>
                                                                        </td>
                                                                        <td><span
                                                                                class="spec-badge">${d.storage}</span>
                                                                        </td>
                                                                        <td>${d.unit}</td>
                                                                        <td><span
