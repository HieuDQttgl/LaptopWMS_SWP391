...
<html>
    ...
    <head>
        <title>Customer Details - WMS</title>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="detail-row">
                ...
                <div class="detail-value">${customer.partnerEmail}</div>
            </div>

            <div class="detail-row">
                <div class="detail-label">Phone</div>
                <div class="detail-value">${customer.partnerPhone}</div>
            </div>
            ...
            <div class="actions">
                <a href="customer-list" class="btn-back">← Back to List</a>
            </div>
        </div>
