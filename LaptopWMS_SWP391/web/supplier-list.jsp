                    ...
                    <body>
                        ...
                        <div class="container">
                            ...
                            <% String successMessage=(String) request.getSession().getAttribute("message"); String
                                errorMessage=(String) request.getSession().getAttribute("error"); Users
                                currentUser=(Users) request.getAttribute("currentUser"); boolean isAdmin=currentUser
                                !=null && currentUser.getRoleId()==1; boolean canChangeStatus=currentUser !=null &&
                                (currentUser.getRoleId()==1 || currentUser.getRoleId()==2); String
                                currentKeyword=(String) request.getAttribute("keyword"); String currentStatus=(String)
                                request.getAttribute("status_filter"); String currentSortField=(String)
                                request.getAttribute("sort_field"); String currentSortOrder=(String)
                                request.getAttribute("sort_order"); if (currentKeyword==null) { currentKeyword="" ; } if
                                (currentStatus==null) { currentStatus="all" ; } if (currentSortField==null) {
                                currentSortField="supplier_id" ; } if (currentSortOrder==null) { currentSortOrder="ASC"
                                ; } if (errorMessage !=null) {%>
                                <p id="notification" class="message-error notification">
                                    <%= errorMessage%>
                                </p>
                                <% request.getSession().removeAttribute("error"); } else if (successMessage !=null) {%>
