                    ...
                    <body>
                        ...
                        <div class="container">
                            ...
                            <% String successMessage=(String) request.getSession().getAttribute("message"); String
                                errorMessage=(String) request.getSession().getAttribute("error"); Map<String, String>
                                errors = (Map<String, String>) request.getAttribute("errors");
                                    ...
                                    <% if (isAdmin) { %>
                                        <a href="<%= request.getContextPath() %>/add-supplier" class="btn-add">Add New
                                            Supplier</a>
                                        <% } %>
                                                    ...
                                                    <div class="filter-controls">
                                                        ...
                                                        <div class="filter-group">
                                                            ...
                                                            <select name="status_filter" id="statusFilter">
                                                                ...
                                                                <option value="active" <%="active"
                                                                    .equals(currentStatus) ? "selected" : "" %>>Active
                                                                </option>
                                                                <option value="inactive" <%="inactive"
                                                                    .equals(currentStatus) ? "selected" : "" %>>Inactive
                                                                </option>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="filter-group">
                                                            ...
                                                            <select name="sort_order" id="sortOrder">
                                                                <option value="ASC" <%="ASC" .equals(currentSortOrder)
                                                                    ? "selected" : "" %>>Ascending</option>
                                                                <option value="DESC" <%="DESC" .equals(currentSortOrder)
                                            ...
                                            <% if (isAdmin) { %>
                                                <div id="addFormContainer" class="add-form-container"
                                                    ...
                                                    <form action="supplier-list" method="post">
                                                        ...
                                                        <% String supplierNameValue=(tempSupplier !=null &&
                                                            tempSupplier.getSupplierName() !=null) ?
                                                            tempSupplier.getSupplierName() : "" ; String
                                                            supplierEmailValue=(tempSupplier !=null &&
                                                            tempSupplier.getSupplierEmail() !=null) ?
                                                            tempSupplier.getSupplierEmail() : "" ; String
                                                            supplierPhoneValue=(tempSupplier !=null &&
                                                            tempSupplier.getSupplierPhone() !=null) ?
                                                            ...
                                                            <% if (errors !=null && errors.containsKey("supplierName"))
                                                                ...
                                                                <% }%>
                                                                    ...
                                                                    <% if (errors !=null &&
                                                                        errors.containsKey("supplierEmail")) {%>
                                                                        <span class="field-error">
                                                                            <%= errors.get("supplierEmail")%>
                                                                        </span>
                                                                        <% }%>

                                                                            <label for="supplierPhone">Phone
                                                                                Number:</label>
                                                                            ...
                                                                            <% if (errors !=null &&
                                                                                errors.containsKey("supplierPhone")) {%>
                                                                                <span class="field-error">
                                                                                    <%= errors.get("supplierPhone")%>
                                                                                </span>
                                                                                <% }%>
                                                ...
                                                <% } %>
                                                    ...
                                                    <!-- Supplier Table -->
                                                    <table id="supplierTable" style="display: <%= showFormOnLoad ? "
                                                        none" : "table" %>;">
                                                        <thead>
                                                            <tr>
                                                                <th>ID</th>
                                                        ...
                                                        <tbody>
                                                            <% List<Supplier> suppliers = (List<Supplier>)
                                                    ...
                                                    <p id="totalSuppliers"
                                                        style="margin-top: 20px; color: #7f8c8d; display: <%= showFormOnLoad ? "
                                                        none" : "block" %>;">
                                                        Total Suppliers: <%= suppliers !=null ? suppliers.size() : 0%>
                                                    </p>
                                                    <a id="backLanding" href="<%= request.getContextPath()%>/landing"
                                                        class="btn-secondary" style="display: <%= showFormOnLoad ? "
                                                        none" : "inline-block" %>;">Back to Landing Page</a>
                        </div>
